...
6. Restliche Felder ausfüllen, auch solange Google noch „nicht öffentlich
   sichtbar“ anzeigt: Öffnungszeiten (Mo–Fr 08:00–17:00), Beschreibung,
   Dienstleistungen, Fotos, erster Beitrag, Q&A. Copy-Paste unter `/admin/system`.
   Website auf `https://www.muc-cargo.de` (nicht `http://`).
...
| Kategorie | Frachtspeditionsdienst (ganzen Namen ins Feld tippen; nur „Fracht“ gibt es nicht. Fallback: auf Logistik klicken → Logistikdienst) |
| Straße | Südallee |
...
| Website | https://www.muc-cargo.de (nicht http://) |
| Pin | 48.350443, 11.767121 |
| Gründungsjahr | 2003 |
| Öffnungszeiten | Mo–Fr 08:00–17:00, Sa/So geschlossen |
| Zusatz | Für zeitkritische Sendungen 24/7 erreichbar |
| Weitere Kategorien | Spedition, Logistikdienst |
...
> Luftfracht-Handling am Flughafen München seit 2003: Import und Export,
> Airline Handling sowie Röntgen- und Sicherheitskontrollen. MUC
> Cargohandling GmbH ist reglementierter Beauftragter (DE/RA/01278-01).
> Büro im Frachtzentrum, Modul H, Pavillon; Warenannahme Modul E, E48,
> Rampe 51. Bürozeiten Montag bis Freitag 08:00–17:00 Uhr. Für zeitkritische
> Sendungen 24/7 erreichbar. Persönliche Ansprechpartner, kurze Wege zum
> Cargo-Drehkreuz.
